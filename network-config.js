...
test('\n\n***** use the connection profile file  *****\n\n', function(t) {
	...
	//  organization.
	var client_org1 = Client.loadFromConfig('/opt/gopath/src/github.com/deevotech/config-hyperledger-bftsmart/config/mynetwork.yaml');
	var client_org2 = Client.loadFromConfig('/opt/gopath/src/github.com/deevotech/config-hyperledger-bftsmart/config/mynetwork.yaml');
	...
	client_org1.loadFromConfig('/opt/gopath/src/github.com/deevotech/config-hyperledger-bftsmart/config/myorg1.yaml');
	client_org2.loadFromConfig('/opt/gopath/src/github.com/deevotech/config-hyperledger-bftsmart/config/myorg2.yaml');
	...
	.then((nothing) => {
		...
		let request = {
			targets: ['peer1-org1'], // this does assume that we have loaded a
		...
		let eventhub = channel_on_org1.newChannelEventHub('peer1-org1');
		...
		return client_org1.queryInstalledChaincodes('peer1-org1', true); // use admin
	}).then((results) => {
